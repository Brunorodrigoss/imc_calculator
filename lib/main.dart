  ...
  void _calculate() {
    setState(() {
      ...
      if (imc < 18.6) {
        ...
        _infoText = "Obesity level I (${imc.toStringAsPrecision(4)})";
      } else if (imc >= 34.9 && imc < 39.9) {
        _infoText = "Obesity level II (${imc.toStringAsPrecision(4)})";
      } else if (imc >= 40) {
        _infoText = "Obesity level III (${imc.toStringAsPrecision(4)})";
      }
    });
  }
